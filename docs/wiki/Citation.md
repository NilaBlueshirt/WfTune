...
If you use WfTune's measurement methodology in your research, cite the original
study below. These blocks are ready to copy into a bibliography or reference
list.
...
[DOI: 10.48550/arXiv.2608.13824](https://doi.org/10.48550/arXiv.2608.13824)

## BibTeX

```bibtex
@misc{mu2026balancing,
  ...
  archivePrefix = {arXiv},
  primaryClass  = {cs.DC},
  doi           = {10.48550/arXiv.2608.13824},
  url           = {https://arxiv.org/abs/2608.13824}
}
```
...
repository. The paper reports the original four-backend Nextflow study;
